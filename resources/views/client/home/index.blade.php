...
@section('content')
    ...
    <section class="slider-area position-relative">
        <div class="third-slider-active">
            <div class="third-slider-item third-slider-bg" data-background="{{ asset('templates/client/img/slider/third_slider_bg.jpg') }}">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="slider-content">
                                    ...
                                    <a href="#" class="btn" data-animation-in="fadeInUp" data-delay-in=".8" data-duration-in="1.5">Shop now</a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="third-slider-img">
                                    ...
                                    <img src="{{ asset('templates/client/img/slider/third_slider_img01.png') }}" alt="" class="main-img" data-animation-in="slideInRight2"
        ...
        <div class="container custom-container-two">
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-9">
                    <div class="shoes-cat-item mb-50">
                        <div class="thumb mb-30">
                            <a href="shop-sidebar.html"><img src="{{ asset('templates/client/img/images/shoes_cat_img01.jpg') }}" alt=""></a>
                        </div>
                        <div class="content">
                            <ul>
                ...
                <div class="col-lg-4 col-md-6 col-sm-9">
                    <div class="shoes-cat-item mb-50">
                        <div class="thumb mb-30">
                            <a href="shop-sidebar.html"><img src="{{ asset('templates/client/img/images/shoes_cat_img02.jpg') }}" alt=""></a>
                        </div>
                        <div class="content">
                            <ul>
                ...
                <div class="col-lg-4 col-md-6 col-sm-9">
                    <div class="shoes-cat-item mb-50">
                        <div class="thumb mb-30">
                            <a href="shop-sidebar.html"><img src="{{ asset('templates/client/img/images/shoes_cat_img03.jpg') }}" alt=""></a>
                        </div>
                        <div class="content">
                            <ul>
                    ...
                    <div class="tab-content tp-tab-content" id="trendingTabContent">
                        <div class="tab-pane show active" id="accessories" role="tabpanel" aria-labelledby="accessories-tab">
                            <div class="trending-products-banner banner-animation">
                                <a href="shop-sidebar.html"><img src="{{ asset('templates/client/img/images/trending_banner03.jpg') }}" alt=""></a>
                            </div>
                            <div class="row trending-product-active">
                                    ...
                                    <div class="features-product-item">
                                        <div class="features-product-thumb">
                                            ...
                                            <a href="shop-details.html">
                                                <img src="{{ asset('templates/client/img/product/shoes_product01.jpg') }}" alt="">
                                            </a>
                                ...
                                <div class="col">
                                    <div class="features-product-item">
                                        <div class="features-product-thumb">
                                            <a href="shop-details.html">
                                                <img src="{{ asset('templates/client/img/product/shoes_product02.jpg') }}" alt="">
                                            </a>
                                            <div class="product-overlay-action">
                                                <ul>
                                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                ...
                                <div class="col">
                                    <div class="features-product-item">
                                        <div class="features-product-thumb">
                                            <a href="shop-details.html">
                                                <img src="{{ asset('templates/client/img/product/shoes_product03.jpg') }}" alt="">
                                            </a>
                                            <div class="product-overlay-action">
                                                <ul>
                                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                ...
                                <div class="col">
                                    <div class="features-product-item">
                                        <div class="features-product-thumb">
                                            <a href="shop-details.html">
                                                <img src="{{ asset('templates/client/img/product/shoes_product04.jpg') }}" alt="">
                                            </a>
                                            <div class="product-overlay-action">
                                                <ul>
                                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                ...
                                <div class="col">
                                    <div class="features-product-item">
                                        <div class="features-product-thumb">
                                            <div class="discount-tag">-20%</div>
                                            <a href="shop-details.html">
                                                <img src="{{ asset('templates/client/img/product/shoes_product05.jpg') }}" alt="">
                                            </a>
                                            <div class="product-overlay-action">
                                                <ul>
                                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                ...
                                <div class="col">
                                    <div class="features-product-item">
                                        <div class="features-product-thumb">
                                            <div class="discount-tag">-20%</div>
                                            <a href="shop-details.html">
                                                <img src="{{ asset('templates/client/img/product/shoes_product06.jpg') }}" alt="">
                                            </a>
                                            <div class="product-overlay-action">
                                                <ul>
                                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                        ...
                        <div class="tab-pane" id="bags" role="tabpanel" aria-labelledby="bags-tab">
                            <div class="trending-products-banner banner-animation">
                                <a href="shop-sidebar.html"><img src="{{ asset('templates/client/img/images/trending_banner02.jpg') }}" alt=""></a>
                            </div>
                            <div class="row trending-product-active">
                                <div class="col">
                                    <div class="features-product-item">
                                        <div class="features-product-thumb">
                                            <div class="discount-tag">-20%</div>
                                            <a href="shop-details.html">
                                                <img src="{{ asset('templates/client/img/product/shoes_product07.jpg') }}" alt="">
                                            </a>
                                            <div class="product-overlay-action">
                                                <ul>
                                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                ...
                                <div class="col">
                                    <div class="features-product-item">
                                        <div class="features-product-thumb">
                                            <a href="shop-details.html">
                                                <img src="{{ asset('templates/client/img/product/shoes_product08.jpg') }}" alt="">
                                            </a>
                                            <div class="product-overlay-action">
                                                <ul>
                                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                        ...
                        <div class="tab-pane" id="bSellers" role="tabpanel" aria-labelledby="bSellers-tab">
                            <div class="trending-products-banner banner-animation">
                                <a href="shop-sidebar.html"><img src="{{ asset('templates/client/img/images/trending_banner.jpg') }}" alt=""></a>
                            </div>
                            <div class="row trending-product-active">
                                <div class="col">
                                    <div class="features-product-item">
            ...
            <div class="row new-arrival-active">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-one">
                    <div class="new-arrival-item text-center mb-50">
                        <div class="thumb mb-25">
                            <div class="discount-tag">- 20%</div>
                            <a href="shop-details.html"><img src="{{ asset('templates/client/img/product/shoes_arrival_product02.jpg') }}" alt=""></a>
                            <div class="product-overlay-action">
                                <ul>
                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                    <li><a href="shop-details.html"><i class="far fa-eye"></i></a></li>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two cat-one">
                    <div class="new-arrival-item text-center mb-50">
                        <div class="thumb mb-25">
                            <a href="shop-details.html"><img src="{{ asset('templates/client/img/product/shoes_arrival_product03.jpg') }}" alt=""></a>
                            <div class="product-overlay-action">
                                <ul>
                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                    <li><a href="shop-details.html"><i class="far fa-eye"></i></a></li>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two">
                    <div class="new-arrival-item text-center mb-50">
                        <div class="thumb mb-25">
                            ...
                            <a href="shop-details.html"><img src="{{ asset('templates/client/img/product/shoes_arrival_product04.jpg') }}" alt=""></a>
                            <div class="product-overlay-action">
                                <ul>
                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                    <li><a href="shop-details.html"><i class="far fa-eye"></i></a></li>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-one">
                    <div class="new-arrival-item text-center mb-50">
                        <div class="thumb mb-25">
                            <div class="discount-tag">- 20%</div>
                            <a href="shop-details.html"><img src="{{ asset('templates/client/img/product/shoes_arrival_product05.jpg') }}" alt=""></a>
                            <div class="product-overlay-action">
                                <ul>
                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                    <li><a href="shop-details.html"><i class="far fa-eye"></i></a></li>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two cat-one">
                    <div class="new-arrival-item text-center mb-50">
                        <div class="thumb mb-25">
                            <div class="discount-tag new">New</div>
                            <a href="shop-details.html"><img src="{{ asset('templates/client/img/product/shoes_arrival_product06.jpg') }}" alt=""></a>
                            <div class="product-overlay-action">
                                <ul>
                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                    <li><a href="shop-details.html"><i class="far fa-eye"></i></a></li>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-one">
                    <div class="new-arrival-item text-center mb-50">
                        <div class="thumb mb-25">
                            <a href="shop-details.html"><img src="{{ asset('templates/client/img/product/shoes_arrival_product07.jpg') }}" alt=""></a>
                            <div class="product-overlay-action">
                                <ul>
                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                    <li><a href="shop-details.html"><i class="far fa-eye"></i></a></li>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two">
                    <div class="new-arrival-item text-center mb-50">
                        <div class="thumb mb-25">
                            ...
                            <a href="shop-details.html"><img src="{{ asset('templates/client/img/product/shoes_arrival_product08.jpg') }}" alt=""></a>
                            <div class="product-overlay-action">
                                <ul>
                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                    <li><a href="shop-details.html"><i class="far fa-eye"></i></a></li>
